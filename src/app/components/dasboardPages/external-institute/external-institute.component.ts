...
@Component({
  selector: 'app-external-institute',
  templateUrl: './external-institute.component.html',
  styleUrls: ['./external-institute.component.css']
})
export class ExternalInstituteComponent implements OnInit {
