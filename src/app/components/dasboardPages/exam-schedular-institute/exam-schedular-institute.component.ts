...
@Component({
  selector: 'app-exam-schedular-institute',
  templateUrl: './exam-schedular-institute.component.html',
  styleUrls: ['./exam-schedular-institute.component.css']
})
export class ExamSchedularInstituteComponent implements OnInit {
